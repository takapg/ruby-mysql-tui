...
module RubyMysqlTui
  module UI
    ...
    module ContentBuilder
      ...
      def calculate_start_index(items, selected_index, height)
      ...
      private_class_method :calculate_start_index

      def render_visible_items(items, start_idx, max_rows, selected_index, width)
      ...
      private_class_method :render_visible_items
