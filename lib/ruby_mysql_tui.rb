...
module RubyMysqlTui
  ...
  def self.handle_return(state, client)
    ...
    when :databases then RubyMysqlTui.handle_databases_return(state, client)
    when :tables then RubyMysqlTui.handle_tables_return(state, client)
    end
    state
  end

  def self.handle_databases_return(state, client)
  ...
  def self.handle_tables_return(state, client)
    return if state[:items].empty?
